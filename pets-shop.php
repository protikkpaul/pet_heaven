<?php include 'header.php';?>
						...
						<div class="row no-gutters overlap">
							<div class="col-sm-12 col-md-6">
								...
								<div class="rs-feature-box-1" data-background="images/dummy-img-600x400.jpg">
									<div class="body">
										<h3>30% OFF ONLINE <br> EXCLUSIVES</h3> 
							...
							<div class="col-sm-12 col-md-6">
								<!-- BOX 2 -->
								<div class="rs-feature-box-1 bgdark" data-background="images/dummy-img-600x400.jpg">
									<div class="body">
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12 col-md-12">
						...
						<p class="subheading text-center mb-4">Your pet's health and well-being are our top priority.</p>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12 col-md-12 text-center">
						<a href="#" class="btn btn-secondary mt-5">More Product</a>
					</div>
				</div>
			</div>
		</div>
	...
	<!-- FUN FACT -->
	<div class="bgi-cover-center" data-background="images/dummy-img-1920x900.jpg">
		<div class="content-wrap">
			<div class="container">
